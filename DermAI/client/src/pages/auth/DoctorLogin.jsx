  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (user.role === 'doctor') {
        ...
        toast.error('Please use patient login')
      }
    } catch (error) {
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          <div className="mb-6">
            ...
            <p className="text-center text-gray-600 text-sm">
              Sign in to access patient reports and consultations
            </p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              New doctor?{' '}
              <Link to="/doctor/signup" className="font-medium text-blue-600 hover:text-blue-700 transition-colors">
                Register here
              </Link>
            </p>
          </div>
          ...
          <div className="mt-6 text-center">
            <Link to="/patient/login" className="text-sm text-gray-600 hover:text-blue-600 transition-colors">
